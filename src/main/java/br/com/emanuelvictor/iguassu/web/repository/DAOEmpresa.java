...
//    @Transactional(readOnly = true)
//    @Query("select e from Empresa e WHERE ((e.nome LIKE %:nome% or :nome is null) and (e.cnpj LIKE %:cnpj% or :cnpj is null) and (e.endereco.rua LIKE %:rua% or :rua is null or e.endereco.rua is null) and (e.endereco.numero LIKE %:numero% or :numero is null) and (e.endereco.cep LIKE %:cep% or :cep is null) and (e.endereco.complemento LIKE %:complemento% or :complemento is null) and (e.endereco.bairro.id =:bairro_id or :bairro_id is null or (e.endereco.bairro.id is null)) and (e.endereco.bairro.cidade.id =:cidade_id or :cidade_id is null or (e.endereco.bairro.cidade.id is null)) and (e.endereco.bairro.cidade.estado.id =:estado_id or :estado_id is null or (e.endereco.bairro.cidade.estado.id is null)) and (e.endereco.bairro.cidade.estado.pais.id =:pais_id or :pais_id is null or (e.endereco.bairro.cidade.estado.pais.id is null)))")
//    public List<Empresa> find(@Param("nome") String nome,
//                              @Param("cnpj") String cnpj, @Param("rua") String rua,
//                              @Param("numero") String numero, @Param("cep") String cep,
//                              @Param("complemento") String complemento,
